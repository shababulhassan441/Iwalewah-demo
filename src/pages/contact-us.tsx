...
export default function ContactUsPage() {
  return (
    <span>
      <Seo
        title="Contact Iwalewah | Get in Touch for Support & Inquiries"
        description="Reach out to Iwalewah for any questions, support, or inquiries. Our team is here to help with your shopping experience, product information, and more."
        path="contact-us"
      />
