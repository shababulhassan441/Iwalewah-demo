...
export default function Search() {
  return (
    <span>
      <Seo
        title="Browse Categories on Iwalewah"
        description="Explore a wide range of product categories on Iwalewah, your trusted e-commerce platform. Discover the best products across different categories."
        path="search"
      />
