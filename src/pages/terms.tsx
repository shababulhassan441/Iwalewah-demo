...
import { termsAndServices, TermsSection } from '@settings/terms-data'; // Import the static data
  ...
  return (
    <>
      <Seo
        ...
        description="Iwalewah.com's Terms and Conditions outline the rules and regulations for the use of our website."
        path="terms"
      />
      <PageHeroSection heroTitle="Terms & Conditions" />
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <nav className="hidden mb-8 sm:block md:w-72 xl:w-3/12 2xl:mb-0 lg:-mt-2">
              <ol className="sticky z-10 md:top-16 lg:top-20">
                {termsAndServices?.map((item: TermsSection, index: number) => (
                  <li key={index}>
                    <Link
                      spy={true}
                      offset={-120}
