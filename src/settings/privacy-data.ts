  ...
  export const privacyPolicy: PrivacyPolicySection[] = [
    {
      title: 'Introduction',
      description: `
        <p><strong>Iwalewah Privacy Policy</strong></p>
        <p>This privacy policy sets out how Iwalewah uses and protects your personal data. This policy is provided in a layered format so you can click through to the specific areas set out below. Please also use the Glossary to understand the meaning of some of the terms used in this privacy policy.</p>
        <p>It is important that you read this privacy notice together with our website privacy policy which contains more detailed information about our data processing and can be accessed <a href="#">here</a>.</p>
      `,
    },
    {
      ...
      description: `
        ...
        <p>Iwalewah is made up of different legal entities, details of which can be found <a href="#">here</a>. This privacy policy is issued on behalf of the Iwalewah Group so when we mention Iwalewah, “we”, “us” or “our” in this privacy policy, we are referring to the relevant company in Iwalewah Group responsible for processing your data. We will let you know which entity will be the controller for your data when you purchase a product or service with us. Iwalewah is the controller and responsible for this website. Iwalewah.co.uk (our website) is provided by Iwalewah Group (‘we’, ‘our’ or ‘us’). We are the controller of personal data obtained via our website, meaning we are the organisation legally responsible for deciding how and for what purposes it is used.</p>
        <p>We take your privacy very seriously. We collect, use and are responsible for certain personal data about you. When we do so we are subject to the UK General Data Protection Regulation (UK GDPR). Please read this privacy policy carefully as it contains important information on who we are and how and why we collect, store, use and share any information relating to you (your personal data) in connection with your use of our website. It also explains your rights in relation to your personal data and how to contact us or a relevant regulator in the event you have a complaint.</p>
        <p>We have appointed a data protection officer (DPO), who is responsible for overseeing questions in relation to this privacy policy. If you have any questions about this privacy policy, including any requests to exercise <strong>[your legal rights]</strong>, please contact the DPO using the details set out below.</p>
      `,
    },
    {
      title: 'Purpose of This Privacy Policy',
      description: `
        <p>This privacy policy aims to give you information on how Iwalewah collects and processes your personal data through your use of this website, including any data you may provide through this website when you sign up to our newsletter, purchase a product or service or take part in a competition.</p>
    ...
    },
    {
      ...
      description: `
        ...
        <p><strong>Name:</strong> Emma James</p>
        <p><strong>Email address:</strong> <a href="mailto:privacy@iwalewah.co.uk">privacy@iwalewah.co.uk</a></p>
        <p><strong>Postal address:</strong> Iwalewah House 3-4 Pavilion Parade, Wood Lane, London, W12 0HQ.</p>
        <p>You have the right to make a complaint at any time to the Information Commissioner’s Office (ICO), the UK regulator for data protection issues (<a href="https://www.ico.org.uk/">www.ico.org.uk</a>). We would, however, appreciate the chance to deal with your concerns before you approach the ICO so please contact us in the first instance.</p>
      `,
    },
    {
      title: 'Changes to the Privacy Policy and Your Duty to Inform Us of Changes',
      description: `
        <p>We may change this privacy policy from time to time—when we make significant changes we will take steps to inform you, for example via email. We keep our privacy policy under regular review. This version was last updated on 20 January 2024. Historic versions can be obtained by contacting us.</p>
    ...
    },
    {
      ...
      description: `
        ...
        <ul className="list-disc list-inside">
          ...
          <li><strong>Financial Data</strong> includes payment card details and/or bank account.</li>
        ...
        <ul className="list-disc list-inside">
          ...
          <li><strong>Third parties or publicly available sources.</strong> We will receive personal data about you from various third parties and public sources as set out below:
            <ul className="list-disc list-inside ml-5">
              ...
              <li>advertising networks in and outside the UK; and</li>
              <li>search information providers in and outside the UK.</li>
              <li><strong>Contact, Financial and Transaction Data from providers of technical, payment and delivery services in and outside the UK.</strong></li>
              <li><strong>Identity and Contact Data from data brokers or aggregators in and outside the UK.</strong></li>
              <li><strong>Identity and Contact Data from publicly available sources such as Companies House and the Electoral Register based inside the UK.</strong></li>
            </ul>
          </li>
        </ul>
      `,
        ...
        <table className="w-full table-auto border-collapse border border-gray-300 mt-4">
          <thead>
            <tr>
              ...
              <th className="border border-gray-300 px-4 py-2 text-left">Lawful Basis for Processing Including Basis of Legitimate Interest</th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    },
    {
      title: 'Marketing',
      description: `
        <p>We strive to provide you with choices regarding certain personal data uses, particularly around marketing and advertising. We have adopted a privacy strategy where you can view and make certain decisions about your personal data use:</p>
    ...
    },
    {
      ...
      description: `
        ...
        <p>Alternatively, you can contact us at any time to opt-out.</p>
    ...
    },
    {
      title: 'Cookies',
      description: `
        <p>You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use, please <a href="#">link here</a>.</p>
      `,
    },
    {
    ...
    },
    {
      ...
      description: `
        <p>We may share your personal data with the parties set out below for the purposes set out in the table <strong>[Purposes for which we will use your personal data]</strong> above.</p>
        <ul className="list-disc list-inside">
          <li><strong>Internal Third Parties</strong></li>
          <li>Other companies may act as joint controllers or processors and provide IT and system administration services and undertake leadership reporting.</li>
          ...
          <li><strong>Third Parties to Whom We May Choose to Sell, Transfer or Merge Parts of Our Business or Our Assets</strong></li>
          <li>Alternatively, we may seek to acquire other businesses or merge with them. If a change happens to our business, then the new owners may use your personal data in the same way as set out in this privacy policy.</li>
        </ul>
    ...
    },
    {
      ...
      description: `
        ...
        <p>We ensure your personal data is protected by requiring all our group companies to follow the same rules when processing your personal data. These rules are called “binding corporate rules”.</p>
        ...
        <p>If we need to transfer your personal data out of the UK, we ensure a similar degree of protection is afforded to it by ensuring at least one of the following safeguards is implemented:</p>
        <ul className="list-disc list-inside ml-5">
        ...
        <p>Please contact us if you want further information on the specific mechanism used by us if we need to transfer your personal data out of the UK.</p>
      `,
    },
    {
      title: 'Data Security',
    ...
    },
    {
      ...
      description: `
        ...
        <p><strong>By law we have to keep basic information about our customers (including Contact, Identity, Financial and Transaction Data) for six years after they cease being customers for [tax] purposes.</strong></p>
    ...
    },
    {
      ...
      description: `
        ...
        <p>Other companies may act as joint controllers or processors and provide IT and system administration services and undertake leadership reporting.</p>
        
        <p><strong>External Third Parties</strong></p>
        <p>Service providers acting as processors who provide IT and system administration services.<br/>Professional advisers who provide consultancy, banking, legal, insurance and accounting services.<br/>HM Revenue & Customs, regulators and other authorities acting as processors or joint controllers based in the United Kingdom who require reporting of processing activities in certain circumstances.</p>
